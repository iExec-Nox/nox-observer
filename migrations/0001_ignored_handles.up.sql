...
--    - handles_unresolved_since: Hasura-tracked function + supporting index


-- 1. Add `ignored` column and rebuild the S3 hot-loop index to exclude ignored rows.
...
-- 2. Drop and recreate the table `subgraph_poller_state` to use the new column

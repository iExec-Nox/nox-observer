-- Handle-stats query: counts unresolved handles for a chain and reports the
-- block range they span, alongside ignored/resolved-but-unseen/latest-seen
-- reference figures. Backs GET /v0/handles/stats.
--
-- $1 = chain_id
